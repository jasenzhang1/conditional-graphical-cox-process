...
unpack <- function(n, movement, VR, epoch_or_week, ew_num, min_edges, df_brain_region, results_root){
  ...
  results_root <- paste(results_root, #"/u/home/j/jasenzz/Graphical_Cox_Process/GMpp-main/results_alzheimers/"
                        '/',
                        sep = setting_ID)
