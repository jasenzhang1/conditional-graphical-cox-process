...
experiment_folder='experiment_14'
...
if [ "$cluster" == "hoffman" ]; then
    ...
    y_c_bandwidth=0.00001 # usually its 0.3, exp(-gamma * y_c_diff^2), use NULL for default
    ...
    region="BOTH_100_NORMALIZED"   # "HIP", "EHC", or "HIP_EHC" "BOTH_100", "BOTH_150", "BOTH_100_NORMALIZED"
