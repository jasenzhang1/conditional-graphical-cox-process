...
#
# 1/12/2026  - v4: expand to allow fitting mice data (WIP)
# 
# ---------------------------------------------------------------------------
...
# 1) fitting method, mice or simu?

model_type="simu"  # simu or mice
method="CPGM"

# 2) initialize parameters for simu and/or mice

mkdir -p script_outputs
max_jobs=60

if [[ "$model_type" == "simu" ]]; then
