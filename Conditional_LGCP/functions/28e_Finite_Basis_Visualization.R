...
visualize_finite_basis <- function(truth_file_name, estimates_file_name, graph_ids, ground_truth, beta_truth, X_truth, eigen_troubleshoot){
  ...
  # - eigen_troubleshoot    (boolean)             does step_4 have eig1 eig2 eig3 suffixes?
  #
  # outputs:
  #
  ...
  g_comparisons <- visualize_over_time(merged, graph_ids, ground_truth, beta_truth, X_truth, eigen_troubleshoot)
