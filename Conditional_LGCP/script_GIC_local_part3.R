...
if(model_type == 'mice'){
  ...
  id_suffix <- as.numeric(args[10])   # suffix index
  k         <- as.numeric(args[11])   # tau_c index
  l         <- as.numeric(args[12])   # tau_p index
  ...
  id_suffix <- as.numeric(args[9])    # suffix index
  k         <- as.numeric(args[10])   # tau_c index
  l         <- as.numeric(args[11])   # tau_p index
