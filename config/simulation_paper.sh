# ------------------------------------------------------------------------------
# Simulation settings for Section 5 of the manuscript.
#
#   make simulations                              (uses this file)
#   ./scripts_exec/run_simulations.sh config/simulation_paper.sh
#
...
rep_ids=($(seq 1 50))       # 50 replications
